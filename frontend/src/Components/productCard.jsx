...
export const ProductCard = ({ produit }) => {
  const {_id, name, description, image, price } = produit;
          ...
          <div className="px-5 pb-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-white bg-purple-700/100 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium
